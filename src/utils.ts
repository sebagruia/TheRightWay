...
export const itemsCategory: ItemsCategory[] = [
  { id: 1, iconName: 'fa-solid fa-lemon', name: 'Fructe', color: '#d39e00' },
  { id: 2, iconName: 'fa-solid fa-pepper-hot', name: 'Legume', color: '#32CD32' },
  { id: 3, iconName: 'fa-solid fa-martini-glass-citrus', name: 'Alcool', color: '#b33939' },
  { id: 4, iconName: 'fa-solid fa-cookie', name: 'Patiserie', color: '#FF69B4' },
  { id: 5, iconName: 'fa-solid fa-fish', name: 'Peste', color: '#10246a' },
  { id: 6, iconName: 'fa-solid fa-ice-cream', name: 'Dulciuri', color: '#9370DB' },
  { id: 7, iconName: 'fa-solid fa-cow', name: 'Lactate', color: '#00CED1' },
  { id: 8, iconName: 'fa-solid fa-venus', name: 'Cosmetice', color: '#6c757d' },
  { id: 9, iconName: 'fa-solid fa-seedling', name: 'Seminte', color: '#2b3f5d' },
  { id: 10, iconName: 'fa-solid fa-dog', name: 'Animale Companie', color: '#FF8C00' },
  { id: 11, iconName: 'fa-solid fa-capsules', name: 'Farmacie', color: '#DC143C' },
  { id: 12, iconName: 'fa-solid fa-house-chimney-crack', name: 'Intretinere casa', color: '#1E90FF' },
  { id: 13, iconName: 'fa-solid fa-child-reaching', name: 'Copil', color: '#FFB6C1' },
  { id: 15, iconName: 'fa-solid fa-bottle-droplet', name: 'Uleiuri', color: '#228B22' },
  { id: 16, iconName: 'fa-solid fa-drumstick-bite', name: 'Carne', color: '#8B4513' },
