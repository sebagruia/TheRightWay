  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          {
            src: '/TheRightWay//favicon.ico',
            sizes: '64x64 32x32 24x24 16x16',
            type: 'image/x-icon',
          },
          {
            src: '/TheRightWay//TheRightWaylogo512.png',
            sizes: '512x512',
            type: 'image/png',
            purpose: 'maskable',
          },
          {
            src: '/TheRightWay//TheRightWaylogo192.png',
            sizes: '192x192',
            type: 'image/png',
            purpose: 'any',
          },
        ...
        screenshots: [
          {
            src: '/TheRightWay//TheRightWayscreenshot.png',
            sizes: '2560x1431',
            type: 'image/png',
